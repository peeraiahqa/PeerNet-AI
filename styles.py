...
.pn-desktop-login-logo::before,
.pn-mobile-login-logo::before {
    content:""!important;
    position:absolute!important;
    z-index:-1!important;
    left:50%!important;
    ...
    border-radius:50%!important;
    background:
        radial-gradient(circle at 30% 45%,rgba(34,211,238,.24),transparent 48%),
        radial-gradient(circle at 68% 38%,rgba(99,102,241,.22),transparent 50%),
        radial-gradient(circle at 54% 72%,rgba(217,70,239,.16),transparent 54%)!important;
    filter:blur(14px)!important;
    transform:translate(-50%,-50%)!important;
    pointer-events:none!important;
    opacity:.88!important;
    animation:pn-logo-glow 5.5s ease-in-out infinite alternate!important;
}
...
.pn-mobile-login-logo img {
    ...
    z-index:1!important;
    filter:
        drop-shadow(0 8px 17px rgba(29,78,216,.13))
        drop-shadow(0 0 9px rgba(103,232,249,.10))!important;
}

@keyframes pn-logo-glow {
    0% {
        opacity:.66;
